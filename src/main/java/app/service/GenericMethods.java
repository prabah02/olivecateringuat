...
public void processSendMail(HttpServletRequest request){
	...
	System.out.println(message);
		try {
			mail.Send("hugeltechnologies","ExpCer!1018","olivecatering2015@gmail.com","A new contact us message submitted on"+SmallUtils.getCurrentDate()+" "+SmallUtils.getMillSecs(),message);
